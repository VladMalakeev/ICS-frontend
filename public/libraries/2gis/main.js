DG.then(function () {
    ...
    $('.policlinica').click(function () {
        DG.popup()
            .setLatLng([46.461976, 30.748646])
            .setContent('Студенческая поликлиника' + '<br>' +
                '<a target="_blank" class="pops" href="https://2gis.ua/odessa/directions/points/%7C30.748646%2C46.461976%3B1970853118126154?m=30.756245%2C46.461976%2F11.97">Открыть в 2ГИС</a>')
            .openOn(map);
        map.setView([46.461976, 30.748646]);
    });
});